function initSite() {
    const sectionIds = ['about-me', 'research', 'presentations', 'publications', 'teaching', 'resume'];
    ...
    function buildSearchIndex() {
        ...
        const candidates = Array.from(pageContent.querySelectorAll('article, .resume-panel'));
        const seen = new Set();
